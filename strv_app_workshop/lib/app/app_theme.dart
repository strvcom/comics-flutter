...
import 'package:strv_app_workshop/core/resources/dimen.dart';
...
class LightTheme extends BaseTheme {
  static ThemeData getTheme() {
    ...
    return ThemeData(
      ...
      primaryColor: ColorRes.NAV_BAR,
      primaryColorDark: ColorRes.NAV_BAR,
...
class DarkTheme extends BaseTheme {
  static ThemeData getTheme() {
    ...
    return ThemeData(
      ...
      backgroundColor: Colors.grey,
      dividerColor: Colors.grey,
      primaryColor: ColorRes.DARK_VARIANT_NAV_BAR,
      primaryColorDark: ColorRes.DARK_VARIANT_NAV_BAR,
