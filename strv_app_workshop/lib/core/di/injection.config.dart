...
import '../network/api_provider.dart' as _i5;
import '../network/interceptors/logging_interceptor.dart' as _i3;
import '../utils/preferences.dart' as _i4;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i3.LoggingInterceptor>(() => _i3.LoggingInterceptor());
  await gh.factoryAsync<_i4.Preferences>(() => injectionModule.prefs,
      preResolve: true);
